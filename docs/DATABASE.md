...
Observação: pedidos novos salvam o serviço escolhido em `serviceId`. A descrição ainda mantém o prefixo legado com o ID do serviço para compatibilidade com a UI atual e com pedidos antigos.
