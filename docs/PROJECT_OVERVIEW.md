...
- `ProviderThemePreset`: preset visual salvo para personalização simples da página pública.
...
- Presets visuais da página pública são recurso PRO. FREE sempre renderiza o tema padrão publicamente, mesmo que exista outro preset salvo por uso anterior do PRO.
