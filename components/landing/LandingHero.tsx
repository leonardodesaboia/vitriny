              ...
              <div className="flex-1 p-5">
                ...
                <div className="mb-4 grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div
                      key={s.label}
                      className="rounded-lg border border-paper-soft bg-paper p-3 text-center"
                    >
                ...
                {[
                  ...
                  >
                    ...
                    <span
                      className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${row.color}`}
                    >
                      {row.status}
                    </span>
                  </div>
