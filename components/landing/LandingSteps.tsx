    ...
    <div className="overflow-hidden rounded-xl border border-paper-soft bg-paper">
      <div className="border-b border-paper-soft bg-white px-4 py-2">
        <p className="text-[10px] text-ink-muted">
          vitriny.com/u/
          <span className="font-semibold text-leaf">joao-eletrica</span>
        </p>
      </div>
      <div className="p-4">
        ...
        <div className="mt-3 flex flex-wrap gap-1.5">
          {["Instalação", "Manutenção", "Reforma"].map((s) => (
            <span
              key={s}
              className="rounded-full bg-mint px-2 py-0.5 text-[10px] font-semibold text-leaf"
            >
              {s}
            </span>
          ))}
      ...
      <div className="p-4">
        ...
        <div className="mt-3 border-t border-paper-soft pt-3">
          <div className="flex justify-between">
            ...
            <span className="font-fraunces text-sm font-bold text-leaf">
              R$ 2.000
            </span>
          </div>
        </div>
        <div className="mt-3 flex gap-2">
          <div className="flex-1 rounded-md border border-paper-soft py-1.5 text-center text-[11px] font-semibold text-ink-muted">
            Recusar
          </div>
          <div className="flex-1 rounded-md bg-leaf py-1.5 text-center text-[11px] font-semibold text-white">
            Aprovar
          </div>
        </div>
      </div>
