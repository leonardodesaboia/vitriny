...
const pains = [
  {
    ...
    solution: "Cada pedido chega no painel com nome, serviço e contato. Organizado, rastreado, nunca perdido."
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    solution: "Proposta por link: o cliente abre no celular, vê os itens e aprova com um clique. Sem e-mail, sem PDF."
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    solution: "Painel com status em tempo real: Novo → Proposta enviada → Aprovado. Você vê tudo de relance."
  }
];
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mt-4 text-base leading-7 text-white/60">
            Não é você. É o processo. O OrçaFácil substitui o caos por um fluxo
            ...
            >
              ...
              <div className="my-5 flex items-center gap-3">
                ...
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-leaf/20">
                  <svg className="h-3 w-3 text-leaf" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="mt-2 text-sm font-medium leading-6 text-white/80">{p.solution}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
