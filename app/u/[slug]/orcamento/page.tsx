        ...
        {query.success ? (
          <div aria-live="polite" className="mt-8 rounded-xl border border-mint bg-mint/40 p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {profile.phone ? (
                <a
                  href={`https://wa.me/${phoneToWhatsAppNumber(profile.phone)}?text=${encodeURIComponent(`Olá! Acabei de enviar um pedido pelo seu link no OrçaFácil. Pode confirmar o recebimento?`)}`}
                  target="_blank"
